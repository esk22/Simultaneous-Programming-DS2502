...
namespace DataManagerWindow
{
    class DataInManager
    {
        ...
        /// Description: Parse a string data to an catalog number
        ///------------------------------------------------------------------------------------------------------------
        ...
        ///----------------------------------------------------------------------------------
        /// Function name:  private bool IsTagAvailable(string [] InputData)
        /// Description: Return true if at least one ID Tag is available, return 
        /// false otherwise
        ///----------------------------------------------------------------------------------
        public bool IsTagAvailable(string[] InputData)
        {
        ...
        /// Parse string to eliminate non-char values, and return string
        /// of characters
        public string GetStr(string strIn)
        {
            string strOut = "";
            foreach (char c in strIn)
                if (Char.IsLetterOrDigit(c))
                    strOut += c;
            if (Char.IsDigit(strOut[0]))
                return strOut[0].ToString(); /// number of tags
