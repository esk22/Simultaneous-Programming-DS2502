...
namespace DataManagerWindow
{
    ...
    "-Detect \r\nbelow.\r\n\r\n";
        ...
        /// Description: Detect the USB port which the Hardware device is connected to.
        ///----------------------------------------------------------------------------------
        ...
        /// Description: Intialize the PORT selection list
        ///----------------------------------------------------------------------------------
        ...
        /// Description: Port auto detect button - Auto detect the port the hardware device 
        ///              is connected to. Display the port number (COMX) in the drop down text field.
        ///----------------------------------------------------------------------------------
        ...
        ///              - Byte sent to hardware as signal ==> z
        ...
        /// Description: Intialize the serial port.
        ///----------------------------------------------------------------------------------
        ...
        /// Description: Request data from the ID tag
        ///              - Send read signal ==> r
        ///              - Read data until the the end signal ("finished") is received
        ///              - Call funtion to filter out empty characters from the string data
        ///                (data "12 2 GH" will be "122GH")
        ///----------------------------------------------------------------------------------
        ...
        ///----------------------------------------------------------------------------------
        /// Function name: private bool OpenSelectedPort(string port)
        /// Description: Open the selected port
        ///              - Return true if the hardware is connected to the port
        ///              - Return false otherwise
        ///----------------------------------------------------------------------------------
        private bool OpenSelectedPort(string port)
        {
            string[] ports = SerialPort.GetPortNames();
        ...
        ///              call function to open DataViewWindow
        ///----------------------------------------------------------------------------------
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (ports.Length > 0)
            {
                ...
                if (selected != PortName && selected.Length > 0)
                {
                    if (OpenSelectedPort(selected))
                        OpenDataViewWindow(selected);
                    else
        ...
        /// Description: Open DataViewWindow, update the progress bar
        ///----------------------------------------------------------------------------------
